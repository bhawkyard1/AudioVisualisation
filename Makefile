...
# Template: app
# Command: /opt/Qt5.7.0/5.7/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile AudioVisualisation.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = AudioVisualisation1.0.0
DISTDIR = /home/i7620560/Documents/year3/Innovations/AudioVisualisation/obj/AudioVisualisation1.0.0
LINK          = clang++
...
Makefile: AudioVisualisation.pro .qmake.cache /opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-clang/qmake.conf /opt/Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-clang CONFIG+=debug CONFIG+=qml_debug -o Makefile AudioVisualisation.pro
